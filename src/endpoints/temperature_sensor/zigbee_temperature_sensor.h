...
class TemperatureSensorCTX : public EndpointCTX {
   public:
       TemperatureSensorCTX(uint8_t ep_id_p, float period_p, float (*aTempCB)()) : EndpointCTX(ep_id_p, period_p)
       {
            tempCB = aTempCB;
...
ZB_ZCL_DECLARE_BASIC_ATTRIB_LIST_EXT(basic_attr_list_## ep_name,                                                                    \
                                       &temp_sens_## ep_name.basic_attr.zcl_version,                                                \
                                       &temp_sens_## ep_name.basic_attr.app_version,                                                \
                                       &temp_sens_## ep_name.basic_attr.stack_version,                                              \
                                       &temp_sens_## ep_name.basic_attr.hw_version,                                                 \
                                       temp_sens_## ep_name.basic_attr.mf_name,                                                     \
                                       temp_sens_## ep_name.basic_attr.model_id,                                                    \
                                       temp_sens_## ep_name.basic_attr.date_code,                                                   \
                                       &temp_sens_## ep_name.basic_attr.power_source,                                               \
                                       temp_sens_## ep_name.basic_attr.location_id,                                                 \
                                       &temp_sens_## ep_name.basic_attr.ph_env,                                                     \
                                       temp_sens_## ep_name.basic_attr.sw_ver);                                                     \
ZB_ZCL_DECLARE_TEMP_MEASUREMENT_ATTRIB_LIST(temperature_attr_list_## ep_name,                                                       \
                                           &temp_sens_## ep_name.temp_attr.measure_value,                                           \                      
                                           &temp_sens_## ep_name.temp_attr.min_measure_value,                                       \
                                           &temp_sens_## ep_name.temp_attr.max_measure_value,                                       \
                                           &temp_sens_## ep_name.temp_attr.tolerance);                                              \
