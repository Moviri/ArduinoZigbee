...
ZigbeeDimmableLight::ZigbeeDimmableLight(WriteBrightnessCallback callback, zb_char_t model_id[], unsigned int power_source_type) : ZigbeeEndpoint(model_id, power_source_type),
...
zb_uint8_t ZigbeeDimmableLight::processCommandEP(zb_bufid_t bufid, zb_zcl_parsed_hdr_t *cmd_params)
{
...
zb_ret_t ZigbeeDimmableLight::processCommandDV(zb_zcl_device_callback_param_t *cmd_params)
{
...
zb_uint8_t ZigbeeDimmableLight::setAttribute(zb_zcl_set_attr_value_param_t *attr_p)
{
...
void ZigbeeDimmableLight::setBrightness(zb_uint8_t value)
{
    ...
    m_write_brightness(value);
}

void ZigbeeDimmableLight::setState(zb_bool_t value)
{
    ZB_ZCL_SET_ATTRIBUTE(m_endpoint_id,
                         ZB_ZCL_CLUSTER_ID_ON_OFF,
                         ZB_ZCL_CLUSTER_SERVER_ROLE,
